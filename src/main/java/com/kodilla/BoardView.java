...
public class BoardView {
    ...
    public void resetPositions() {
        ...
        boardLoop.runBoardLoop((columnBoardLoop, rowBoardLoop) -> pawn[columnBoardLoop][rowBoardLoop] = null);
        ...
        pawn[2][2] = new Pawn(Pawn.Name.PANTHER, colourOnTop, 5, "file:src/main/resources/pawns/panther" + colourOnTop + ".png", true);
        ...
        pawn[4][6] = new Pawn(Pawn.Name.PANTHER, colourOnBot, 5, "file:src/main/resources/pawns/panther" + colourOnBot + ".png", true);
