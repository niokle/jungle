...
public class PawnMoveTestSuite {
    ...
    public void testMoveCaseRat() {
        ...
        ArrayList<Coordinates> coordinates = pawnMoves.getMoves(pawn1, whiteOnTop);
    ...
    public void testMoveCaseDog() {
        ...
        //When
        Pawn pawn1 = new Pawn(Pawn.Name.DOG, colorOnTop, 4, "file:src/main/resources/pawns/dog" + colorOnTop + ".png", true);
        ArrayList<Coordinates> coordinates = pawnMoves.getMoves(pawn1, whiteOnTop);
    ...
    public void testMoveCaseLion() {
        ...
        Assert.assertEquals(coordinates2.getColumn(), coordinates.get(0).getColumn());
        Assert.assertEquals(coordinates2.getRow(), coordinates.get(0).getRow());
        Assert.assertEquals(coordinates4.getColumn(), coordinates.get(1).getColumn());
        Assert.assertEquals(coordinates4.getRow(), coordinates.get(1).getRow());
    }
}
